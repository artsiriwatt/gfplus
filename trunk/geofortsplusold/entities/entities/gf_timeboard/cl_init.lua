...
function ENT:Draw()
	...
	cam.Start3D2D(pos,ang,.25)
		...
		draw.DrawText(tostring(self.rounds[GF.round]),"ScoreM",self.x+self.w*.5,self.y,Color(255,255,255,255),TEXT_ALIGN_CENTER)
		draw.DrawText(string.ToMinutesSeconds(GF.roundTimer - CurTime(),0),"ScoreL",self.x+self.w*.5,self.y+32,Color(255,255,255,255),TEXT_ALIGN_CENTER)
	cam.End3D2D()
end
